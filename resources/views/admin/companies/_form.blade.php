...
<table class="table table-striped border item-va-middle table-form">
  ...
  <tr>
    ...
    <td colspan="3">
      @includeWhen($errors->get('public_date'), 'admin._components.validation_error', ['errors' => $errors->get('public_date')])
  ...
  <tr>
    ...
    <td colspan="3">
      @includeWhen($errors->get('tags'), 'admin._components.validation_error', ['errors' => $errors->get('tags')])
      <div class="row">
