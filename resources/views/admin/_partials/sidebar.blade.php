<nav class="sidebar">
  <ul class="nav flex-column accordion" id="nav_accordion">
    ...
    <li class="nav-item">
      ...
      <ul id="menu_item2" class="submenu collapse accordion-collapse show" data-bs-parent="#nav_accordion">
        <li><a class="nav-link" href="{{ route('admin.news_category') }}"><i class="bi bi-chevron-right me-1"></i>お知らせカテゴリ管理</a></li>
      </ul>
    </li>
    <li class="nav-item">
      ...
      <ul id="menu_item2" class="submenu collapse accordion-collapse show" data-bs-parent="#nav_accordion">
        <li><a class="nav-link" href="{{ route('admin.news_category') }}"><i class="bi bi-chevron-right me-1"></i>ユーザー管理</a></li>
      </ul>
    </li>
  </ul>
</nav>