  ...
  <ul class="nav flex-column accordion" id="nav_accordion">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#menu_item2" aria-controls="menu_item2" aria-expanded="true" href="{{ route('admin.news.index') }}">
        お知らせ管理<i class="bi bi-caret-down-fill ms-1"></i>
      </a>
      <ul id="menu_item2" class="submenu collapse accordion-collapse show" data-bs-parent="#nav_accordion">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#menu_item2" aria-controls="menu_item2" aria-expanded="true" href="{{ route('admin.company.index') }}">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#menu_item2" aria-controls="menu_item2" aria-expanded="true" href="{{ route('admin.hr_company.index') }}">
        利用会社管理<i class="bi bi-caret-down-fill ms-1"></i>
      </a>
      <ul id="menu_item2" class="submenu collapse accordion-collapse show" data-bs-parent="#nav_accordion">
        <li><a class="nav-link" href="#"><i class="bi bi-chevron-right me-1"></i>利用ユーザー管理</a></li>
      </ul>
    </li>
  </ul>
</nav>