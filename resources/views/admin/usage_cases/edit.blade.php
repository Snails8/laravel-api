...
@section('content')
  ...
  {{ Form::open(['route' => ['admin.usage_case.update', 'usage_case' => $usage_case->id], 'method' => 'put', 'files' => true]) }}
  @csrf
  @method('PUT')
  ...
  <div class="my-3 pt-3 border-top">
    ...
    <form name="delete" method="POST" action="{{ route('admin.usage_case.destroy', ['usage_case' => $usage_case]) }}" class="d-inline">
      @csrf
      @method('DELETE')
