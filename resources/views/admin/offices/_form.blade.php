...
<table class="table table-striped border item-va-middle table-form">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>支社名</th>
    <td colspan="3">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>電話番号</th>
    <td colspan="3">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>代表者役職名</th>
    <td colspan="3">
