...
<table class="table table-striped border item-va-middle table-form">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>タイトル</th>
    <td colspan="3">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>カテゴリ</th>
    <td colspan="3">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>内容</th>
    <td colspan="3">
  ...
  <tr>
    <th class="bg-dark text-white border-white"><span class="p-2 mr-2 badge badge-danger">必須</span>Description</th>
    <td colspan="3">
